...
private:
     ...
     */
    int32_t getLinePositionX(const Lines& lines, Indices& lineIndices, Direction direction);
     ...
     */
    std::pair<PREC, PREC> getLineParameters(const Lines& lines, Indices& lineIndices, Direction direction);
