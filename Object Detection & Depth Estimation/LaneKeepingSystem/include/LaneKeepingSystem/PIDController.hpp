...
public:
    ...
    PREC saveAngle(PREC angle);

private:
    PREC mProportionalGain;      ///< Proportional control gain. The higher, the more powerful
    PREC mIntegralGain;          ///< Integral control gain to remove error of steady-state
    PREC mDifferentialGain;      ///< Differential control gain to relieve overshoot and improve stability
